...
* Ensure that you have enabled Astra Control Provisioner on the managed cluster. Refer to link:../get-started/enable-acp.html[Enable Astra Control Provisioner^] for instructions.
