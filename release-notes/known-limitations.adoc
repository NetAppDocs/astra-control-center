...
The following limitations apply to the management of clusters using Astra Control Center.
...
The following limitations affect management of applications.
...
These limitations affect other Astra Control Center functionality.
