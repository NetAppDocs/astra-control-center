...
* <<Fluentd integration with clusters managed by declarative Kubernetes workflows is not supported>>
...
== Fluentd integration with clusters managed by declarative Kubernetes workflows is not supported
Astra Control Center does not support Fluentd integration from clusters managed with declarative Kubernetes workflows. You can, however, connect clusters managed using non-Kubernetes-native workflows to Fluentd for log management.
