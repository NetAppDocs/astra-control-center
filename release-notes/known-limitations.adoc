...
== Astra Control Center does not validate the details you enter for your Fluentd server
//From email request
Ensure that you link:../use/monitor-protect.html#connect-to-fluentd[enter the correct values] when establishing a connection.
