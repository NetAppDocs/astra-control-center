...
* <<Snapshots might fail in Astra Control Center 23.04 for Amazon EKS 1.25 or newer clusters>>
...
. Install the snapshot CRDs and the snapshot controller using https://docs.netapp.com/us-en/trident/trident-use/vol-snapshots.html#deploying-a-volume-snapshot-controller[Deploying a volume snapshot controller^].
. Install the latest Astra Trident version using https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy.html[Learn about Astra Trident installation^].
. Create a snapshot class using https://docs.netapp.com/us-en/trident/trident-use/vol-snapshots.html#step-1-create-a-volumesnapshotclass[Create a VolumeSnapshotClass^].
...
. Uninstall Astra Trident using https://docs.netapp.com/us-en/trident/trident-managing-k8s/uninstall-trident.html[Uninstall Astra Trident^].
. Install the snapshot CRDs and the snapshot controller using https://docs.netapp.com/us-en/trident/trident-use/vol-snapshots.html#deploying-a-volume-snapshot-controller[Deploying a volume snapshot controller^].
. Install the latest Astra Trident version using https://docs.netapp.com/us-en/trident/trident-get-started/kubernetes-deploy.html[Learn about Astra Trident installation^].
. Create a snapshot class using https://docs.netapp.com/us-en/trident/trident-use/vol-snapshots.html#step-1-create-a-volumesnapshotclass[Create a VolumeSnapshotClass^].
