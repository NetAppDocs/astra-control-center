...
If you try to add a cluster with the same name of a cluster that already exists in your cloud, the operation will fail. You must remove the existing cluster and corresponding credentials and retry the request.
