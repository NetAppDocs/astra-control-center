...
* <<Astra Control requires applications to include at least one active pod>>
...
Astra can’t manage and protect an application if there are no active pods that match with the label selector criteria specified in the app definition.
