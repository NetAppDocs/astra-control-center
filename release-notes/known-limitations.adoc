...
This release of Astra Control Center does not support in-place restore of apps with certification managers. Cloning operations in this scenario are supported.
