...
* *Astra Control registry option for images*: Astra Control has a new public image Docker registry. You can use this registry to pull Astra Control Provisioner images and other software.
