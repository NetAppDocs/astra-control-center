...
== 27 April 2023 (23.04.0)

.New features and support

* link:../concepts/licensing.[90-day evaluation license enabled by default for new Astra Control Center installations^]
...
* link:../get-started/requirements.html[Support for NAS economy as a storage class type^]
* link:../use/restore-apps.html#filter-resources-during-an-application-restore[Support for including or excluding aplication resources during restore operations^]
