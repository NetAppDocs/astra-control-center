...
* link:../use/upgrade-acc.html[An improved 23.07 Astra Control Center operator is required to upgrade to 23.07]
...
* Support for Longhorn integrations
* Support for MetroCluster MCC configurations
