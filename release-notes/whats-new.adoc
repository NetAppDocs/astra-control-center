...
* link:../use/manage-apps.html#manage-apps[Improved app management that allows you to directly define and manage the apps you care about].
* NetApp SnapMirror disaster recovery workflows.
...
IMPORTANT: The NetApp-provided default pre- and post-snapshot execution hooks for specific applications have been removed in this release. When you upgrade to this release, you must provide your own execution hooks for snapshots or Astra Control will take crash-consistent snapshots only.

====
// End snippet
* Support for Amazon FSx and AWS.
...
* https://docs.netapp.com/us-en/astra-automation/index.html[LDAP authentication (via Astra Control API)].
* link:../get-started/understand-psp-restrictions.html[Pod security policies].
