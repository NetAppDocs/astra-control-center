...
* link:../use/define-custom-app.html[Support for apps that span across multiple namespaces]
* link:../use/define-custom-app.html[Support for including cluster resources in an app definition]
