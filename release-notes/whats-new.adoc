...
* link:../use/manage-apps.html#manage-apps[Improved app management that enables you to directly define and manage the apps you care about]
* Application disaster recovery workflows using NetApp SnapMirror technology.
...
* https://docs.netapp.com/us-en/astra-automation/workflows_infra/ldap_overview.html[LDAP integration (via Astra Control API)^]
