...
* link:../use/manage-apps.html#define-apps[Support for apps that span across multiple namespaces]
* link:../use/manage-apps.html#define-apps[Support for including cluster resources in an app definition]
...
* link:../use/manage-apps.html#define-apps[Improved app management workflow]
