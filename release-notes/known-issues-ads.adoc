...
. Edit the link:../get-started/install_acc.html#configure-astra-control-center[Astra Control Center operator deployment YAML (astra_control_center_operator_deploy.yaml)] to change the Helm install timeout:
+
----
...
. Edit the link:../get-started/install_acc.html#configure-the-astra-control-center-operator[Astra Control Center custom resource (CR) file (astra_control_center_min.yaml)] and include the highlighted additional values under `spec`:
+
[subs=+quotes]
----
