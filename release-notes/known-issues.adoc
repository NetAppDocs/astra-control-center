...
//DOC-3602/ASTRACTL-10186
After Astra Control Center has been running for extended periods (up to 5 days in scaled environment), the ASUP tar bundle download status cannot be determined and the download can time out without any indication in the UI.
...
You can manually delete the pods in the netapp-monitoring namespace and the namespace with the following commands:
