...
You can manually delete the namespace with the following commands:
...
IMPORTANT: Execute the following command only from a remotely managed cluster. Don't execute this command on Astra Control Center host cluster. If you do, it will damage the monitoring operator that exists in the ACC namespace.
