...
Add storage backend to Astra Control to manage your on-premises Kubernetes applications. Astra Control discovers and uses the already-deployed resources, including Trident, ONTAP, and associated storage classes.
...
* /get-started/setup_overview.html#add-a-storage-backend
