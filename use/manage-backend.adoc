...
. In the Edit Authentication page, select one of the following. If the certificate is already enabled, you can only edit the certificate information. You cannot change from certificate-based to credentials-based authentication. 
