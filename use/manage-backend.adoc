...
.What you'll need
* A deployed Astra Data Store storage backend
...
.. If you want Astra Data Store to always use the maximum available number of nodes according to your license, enable the *Always use up to maximum number of nodes allowed* check box. Alternatively, select the desired number of nodes to use.
.. Assign the new node or nodes to Protection Domains.
. Select *Next*.
