...
When you add a bucket, Astra Control appends a default bucket indicator, such as “bucket-002” to the name. The first bucket that you create becomes the default bucket.
