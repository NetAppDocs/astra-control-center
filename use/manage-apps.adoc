...
+
NOTE: Apps can be defined within specified namespaces on a single cluster. Astra Control does not support the ability for apps to span multiple clusters.
