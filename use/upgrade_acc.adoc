...
.About this task
The Astra Control Center upgrade process does the following:

* Upgrades the Astra components in the `netapp-acc` (or custom named) namespace.
* Helps you determine that all Astra Control Center pods are running.
* Upgrades the Astra xxx.
