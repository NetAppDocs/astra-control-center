...
. Select the check box for the apps that you no longer want to manage.
...
. Select the check box for the cluster that you no longer want to manage in Astra Control Center.
