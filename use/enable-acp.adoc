...
You can follow this procedure if you are a licensed Astra Control Center user and you are looking to extend Astra functionality. You should also follow this procedure if you are an Astra Trident user and want to use the additional functionality that Astra Control Provisioner provides without also using Astra Control.
...
* *Confirm that your cluster has an AMD64 system architecture*: The Astra Control Provisioner image is provided in both AMD and ARM architecture types, but only AMD is supported by Astra Control Center.

All Astra Control Provisioner users:

* *Install or upgrade to Astra Trident 23.10*: Refer to https://docs.netapp.com/us-en/trident/trident-managing-k8s/upgrade-trident.html[Astra Trident documentation^] for these procedures.

* *Obtain an Astra Control license*: You'll need a license to use Astra Control Provisioner and the functionality it provides.
