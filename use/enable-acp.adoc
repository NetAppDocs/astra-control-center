...
* *Install or upgrade to Astra Control Center 23.10*: You'll need this version if you are planning to use Astra Control Provisioner with Astra Control. You'll also need the kubectl plugin you used during the installation process if you download the Astra Control Provisioner from the NetApp Support Site.
