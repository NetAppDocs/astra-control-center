...
NOTE: If you are restoring an app that has been deleted, choose a different name for the app than the original name. If the name for the restored app is the same as the deleted app, the restore operation will fail.
