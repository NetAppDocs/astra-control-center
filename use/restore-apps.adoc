...
. (Optional) If need to select only certain resources of the application to restore, add the following fields to `spec`and update the values according to your filtering preference:
+
