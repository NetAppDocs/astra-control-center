...
+
----
minio_1343ff5e-4c41-46b5-af00-7b5bbba63406/backups/schedule-20231213023800_94347756-9d9b-401d-a0c3-a5540f6f54a1
----
...
+
* *<APPVAULT_NAME>*: The name of the AppVault where the backup contents are stored.
* *<BACKUP_PATH>*: The path inside AppVault where the backup contents are stored.
+
----
minio_1343ff5e-4c41-46b5-af00-7b5bbba63406/backups/schedule-20231213023800_94347756-9d9b-401d-a0c3-a5540f6f54a1
----
...
metadata:
  name: snapshotinplacerestore-sample1
  namespace: neptune-system
spec:
  appArchivePath: <BACKUP_PATH>
  appVaultRef: <APPVAULT_NAME> 
