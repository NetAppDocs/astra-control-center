...
+
NOTE: The operator uninstall process does not remove existing secrets. If you create a new secret as part of Astra Control registry access to obtain the latest Astra Control Center image, you might need to update this field.
