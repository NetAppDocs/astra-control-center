...
Learn about an example workflow for making sure your apps are protected against data loss. See the data protection link:../concepts/data-protection.html[concepts^] to learn about the available types of data protection in Astra Control Center.
