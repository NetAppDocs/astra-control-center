...
You can create backups, clones, snapshots, and protection policies for your apps using Astra Control Center. See link:../concepts/data-protection.html[Data protection] to learn about the available types of data protection in Astra Control Center, and when to use them.
