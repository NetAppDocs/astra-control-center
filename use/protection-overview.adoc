...
Create a manual https://docs.netapp.com/us-en/astra-control-center/use/protect-apps.html#create-a-backup[backup^] of all apps, so you are immediately protected.
