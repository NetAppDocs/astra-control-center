...
==== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png[One] Configure a protection policy
...
==== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png[Two] Optional: Adjust the protection policy as needed

[role="quick-margin-para"]
As apps and their usage patterns change, adjust the protection policy as needed to provide the best protection.

==== image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png[Three] In case of a disaster, restore your apps
