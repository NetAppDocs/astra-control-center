...
* *ontap-nas-economy storage class*: If your app uses the `ontap-nas-economy` storage class, clone operations are disruptive and the app will be unavailable until the operation has completed.
...
+
NOTE: If your target storage class does not exist, the default original class will be used.
