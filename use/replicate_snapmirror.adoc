...
+
NOTE: You cannot use the same destination namespace for more than one source namespace, for example, ns1 and ns2 can't both replicate to the same ns-dest. Any conflicting resources in the selected namespaces will be overwritten. 
