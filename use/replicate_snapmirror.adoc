...
* *Managed backends*: You need to add and  manage ONTAP as a storage backend in Astra Control to create a replication relationship. 
+
*_Astra Control Provisioner only_*: Adding an ONTAP storage backend in Astra Control is optional if you have enabled Astra Control Provisioner for Astra Control 23.10 or later.
...
+
*_Astra Control Provisioner only_*: You do not need an admin role in Astra Control to manage clusters.
