...
* *Managed backends*: You need to add and manage ONTAP storage backends in Astra Control to create a replication relationship. 
+
...
+
*_Astra Control Provisioner only_*: You do not need specifically an "admin" role to manage clusters in Astra Control Center. These credentials are no longer required within Astra Control Center.  
