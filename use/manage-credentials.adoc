...
NOTE: If you create your own kubeconfig file, you should normally define only *one* context element in it. See https://kubernetes.io/docs/concepts/configuration/organize-cluster-access-kubeconfig/[Kubernetes documentation^] for information about creating kubeconfig files. If you need multiple contexts, you will need to link:../get-started/setup_overview.html#create-a-cluster-role-kubeconfig[create a cluster role kubeconfig to handle multiple contexts^].
