...
.. For the Read API Access Token key permissions, select: Assets, Alerts, Acquisition Unit, Data Collection.
.. In Cloud Insights, generate a *Read/Write* type API token.
.. For the Read/Write API Access Token key permissions, select: Assets, Data Ingestion, Log Ingestion, Acquisition Unit, Data Collection.
