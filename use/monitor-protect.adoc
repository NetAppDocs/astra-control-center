...
You can enable a Fluent Bit endpoint to expose logs from your containers. The Fluent Bit connection is disabled by default.
...
* A Cloud Insights connection. IS THIS NEEDED??
