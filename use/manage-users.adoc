...
You can change the password of your user account. If your account has Admin or Owner role permissions, you can change the passwords for other user accounts as well as your own.
