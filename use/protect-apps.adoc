...
You can create immutable backups by backing up applications to immutable buckets. Refer to link:../concepts/data-protection.html[Data protection^] for important information about working with immutable backups.
