...
IMPORTANT: If your app uses a storage class backed by the `ontap-nas-economy` driver, snapshots can't be created. Use an alternate storage class for snapshots. Astra Trident and Astra Control Provisioner support snapshot creation using the following drivers:
* `ontap-nas`
* `ontap-san`
* `ontap-san-economy`
...
Astra Trident and Astra Control Provisioner support backup creation and backup restoration using the following drivers:
* `ontap-nas`
* `ontap-nas-economy`
* `ontap-san`
* `ontap-san-economy`
