...
* <DAY_OF_WEEK>: _(Optional)_ The day of the week (0 - 7) that the schedule should run. Values of 0 and 7 indicate Sunday. This field is required if the granularity is set to `weekly`.
