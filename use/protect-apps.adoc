...
+
* https://github.com/NetApp/netapp-astra-toolkits/blob/main/examples/fullcluster-backup/components.yaml[components.yaml CRD file]
* https://github.com/NetApp/netapp-astra-toolkits/blob/main/examples/fullcluster-backup/protectCluster.py[protectCluster.py Python script]
...
. Download the following files to a machine that has network access to your cluster:
+
* https://github.com/NetApp/netapp-astra-toolkits/blob/main/examples/labelbased-backup/components.yaml[components.yaml CRD file]
* https://github.com/NetApp/netapp-astra-toolkits/blob/main/examples/labelbased-backup/protectCluster.py[protectCluster.py Python script]
