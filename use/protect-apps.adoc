...
+
* *<CR_NAME>*: The name of this CR operation; choose a sensible name for your environment.a
...
kind: Snapshot
metadata: 
  name: <CR_NAME> # The name of this CR operation; choose a sensible name for your environment.
spec: 
  applicationRef: <APPLICATION_NAME>
  appVaultRef: <APPVAULT_NAME> # The name of the AppVault where the backup contents are stored.
----
