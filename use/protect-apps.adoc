...
NOTE: If your app uses the `ontap-nas-economy` storage class, snapshots cannot be used. Use an alternate storage class for snapshots. 
...
NOTE: If your app uses the `ontap-nas-economy` storage class, backups are disruptive and the application will be unavailable until the backup operation has completed. 
