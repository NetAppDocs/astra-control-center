...
* link:../use/manage-apps.html#tech-preview-define-an-application-using-a-kubernetes-custom-resource[Define an application using a Kubernetes custom resource]
* link:../use/manage-buckets.html#tech-preview-manage-a-bucket-using-a-custom-resource[Manage a bucket using a custom resource]