...
* *Failed over*: Astra Control uses the most recent (successful) replicated app Snapshot, stops replicating from the source cluster, and restores the Kubernetes resources.
