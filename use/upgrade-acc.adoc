...
... Substitute <MY_FULL_REGISTRY_PATH> with the URL of the repository that includes any sub-directories.
... Run one of the following scripts that is customized for the version of Podman you use.
+
[source]
