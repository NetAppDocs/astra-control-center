...
// End snippet
+
Upgrade your Trident version, if required:
+
[role="tabbed-block"]
====
...
// end tabbed block
+
See the https://docs.netapp.com/us-en/trident/trident-managing-k8s/upgrade-operator-overview.html[Astra Trident documentation^] for more information about Trident upgrades.
