...
* Replace MY_REGISTRY_USER and MY_REGISTRY_PASSWORD with your user credentials for the repository. Alternatively, you can replace the credentials flags with a registry-generated authentication token. 
+
[source,sh]
----
