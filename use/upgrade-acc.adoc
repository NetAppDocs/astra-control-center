...
[%collapsible]
====
Install the latest operator (`acc-operator`) if you are upgrading Astra Control Center. You cannot upgrade to other versions of Astra Control Center using this operator.
====
// End snippet
