...
To upgrade Astra Control Center, download the installation bundle from the https://mysupport.netapp.com/site/[NetApp Support Site^] and perform a series of commands to upgrade the Astra Control Center components in your environment. You can use this procedure to upgrade Astra Control Center in internet-connected or air-gapped environments.
