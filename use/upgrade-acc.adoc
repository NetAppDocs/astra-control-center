...
+
IMPORTANT: Don't attempt to mesh the existing Astra installation. The Istio service mesh must be running in parallel with an existing, un-meshed Astra Control Center installation.
