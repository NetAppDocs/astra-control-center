...
+
----
kubectl delete -f 23.07/trident-installer/deploy/bundle.yaml -n trident
----

.. Update TridentOrchestrator CR to enable Astra Control Provisioner (`--enable-acp=true`):
+
----
