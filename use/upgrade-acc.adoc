...
local-temp-repo/traefik                 0.2.0           2.5.3       Helm chart for Traefik Ingress controller
local-temp-repo/traefik-ingressroutes   0.2.0           2.5.3       A Helm chart for Kubernetes
----
