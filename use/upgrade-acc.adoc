...
* *The latest Astra Control Center operator*
+
[%collapsible]
====
Install the latest operator (`acc-operator`) if you are upgrading to the 23.07 Astra Control Center. You cannot upgrade to other versions of Astra Control Center using this operator.
====
// End snippet
  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        *- name: ACCOP_HELM_UPGRADETIMEOUT*
          *value: 300m*
        *image: ASTRA_IMAGE_REGISTRY/acc-operator:23.04.36*
