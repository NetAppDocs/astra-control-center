...
To determine the version you are running, run the following command in your existing Astra Control Center container: `kubetcl get nodes o -wide`
** Sufficient cluster resources
To determine the version you are running, run the following command in your existing Astra Control Center container: `kubetcl describe node <node name>`
...
To determine your default storage class, run the following command in your existing Astra Control Center container: `kubetcl get storageclass``

* If cluster operators are in use, ensure all cluster operators are in a healthy state and available.
+
----
...
+
----
kubectl get -o yaml -n [netapp-acc or custom namespace] acc
----
+
Response:
+
...
----
+
NOTE: To monitor upgrade status during the operation, use the following command: `k get -o yaml -n <namespace> acc | grep -i upgrading`.
