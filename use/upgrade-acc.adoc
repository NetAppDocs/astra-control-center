...
// End snippet
//astradoc-249
* It is strongly recommended that Astra Control communications channels be secured on the cluster using an Istio service mesh supported by Astra Control.
