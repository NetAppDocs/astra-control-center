...
Astra Trident 22.04 or newer for SnapMirror-based application replication
...
Learn how to link:../use/replication.html[replicate apps to a remote system using SnapMirror technology].
