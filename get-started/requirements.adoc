...
|443/6443
*NOTE*: The port that the managed cluster uses might vary depending on the cluster you manage. Refer to the documentation from your cluster software vendor.
|HTTPS
