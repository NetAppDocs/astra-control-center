...
If you install Istio service mesh on the host cluster, you must do so as part of Astra Control Center link:../get-started/install_acc.html[installation] or link:../use/upgrade-acc.html[upgrade] and not independent of these processes.
