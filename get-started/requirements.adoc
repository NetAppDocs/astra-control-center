...
Astra Trident 22.10 or newer installed for Kubernetes 1.25 clusters
...
* *Manage clusters*: link:../get-started/setup_overview.html#prepare-your-environment-for-cluster-management-using-astra-control[Cluster management requirements^]
* *Manage applications*: link:../use/manage-apps.html#application-management-requirements[Application management requirements^]
* *SnapMirror Disaster Recovery replication*: link:../use/replicate_snapmirror.html#replication-prerequisites[Replication prerequisites^]
