...
=== NetApp MetroCluster
When you use NetApp MetroCluster as a storage backend, you need to specify an SVM management LIF as a backend option in the Astra Trident driver that you use. Refer to Astra Trident documentation for more information about each driver:
