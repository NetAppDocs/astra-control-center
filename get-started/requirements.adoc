...
* OpenShift 4.6 or 4.7 cluster that has Trident StorageClasses backed by ONTAP 9.5 or newer, with at least 300GB of available capacity
...
* *Kubernetes version*: A cluster must be running Kubernetes version 1.19 or newer.
