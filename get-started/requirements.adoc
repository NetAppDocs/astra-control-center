...
Astra Control Center has been validated with the following operational environments:
...
|===
|Operational environment |Supported versions

|Cisco IKS with Kubernetes
|1.22

|Google Anthos
|1.11 or 1.12 (See <<Google Anthos cluster requirements>>)

|(Upstream) Kubernetes
|1.23 to 1.25 (Astra Trident 22.10 or newer is required for Kubernetes 1.25)
...
|1.5  (See <<VMware Tanzu Kubernetes Grid cluster requirements>>)

|VMware Tanzu Kubernetes Grid Integrated Edition
|1.13 and 1.14  (See <<VMware Tanzu Kubernetes Grid cluster requirements>>)
|===
...
|===
|Component |Sub-component |Requirement
...
a|* You need to configure at least one Astra Trident storage class on the cluster. If a default storage class is configured, ensure that it is the only storage class with the default designation.
...
==== Astra Trident
Meet the following Trident requirements according to the needs of your environment:
