...
//DOC-4067
* You must create a pod security policy that allows Astra Control Center to create pods within the cluster. You can do this using the following commands:
+
----
...
When hosting Astra Control Center on a Google Anthos cluster, note the following:

* Google Anthos includes the MetalLB load balancer and the Istio ingress gateway service by default.
