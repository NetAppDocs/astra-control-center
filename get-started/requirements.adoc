...
*	FlexClone
*	SnapMirror: Optional. Needed only for replication to remote systems using SnapMirror technology. Refer to  https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-licensing-concept.html#snapmirror-cloud-license[SnapMirror license information^].
...
Astra Control Center requires an Astra Control Center license for full functionality. Obtain an evaluation license or full license from NetApp. You need a license to protect your applications and data. Refer to the Astra Control Center link:../get-started/intro.html[features] for details.  
...
For details about how licenses work, refer to link:../concepts/licensing.html[Licensing].
