...
Ensure that your environment meets the following requirements to deploy and operate Astra Control Center.
...
For details about licenses needed for ONTAP storage backends, refer to <<ONTAP licenses>>.
