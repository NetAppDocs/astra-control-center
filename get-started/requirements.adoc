...
* The most recent version of the Kubernetes https://kubernetes-csi.github.io/docs/snapshot-controller.html[snapshot-controller component^] must be installed
* The Kubernetes https://kubernetes.io/docs/concepts/storage/volume-snapshot-classes/[volumesnapshotclass component^] must be configured
