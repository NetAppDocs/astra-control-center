...
Astra Control Center has the following requirements for clusters that you plan to add to and manage from Astra Control Center. These requirements also apply if the cluster you plan to manage is the operational environment cluster that hosts Astra Control Center.
