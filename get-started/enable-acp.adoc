...
. If you have Astra Trident 23.07.1 or earlier installed, delete all components:

.. Delete the Trident orchestrator:
+
---- 
kubectl delete -f tridentorchestrator_cr.yaml
----

.. Delete the bundle:
+
----
kubectl delete -f deploy/<bundle_post_1_25.yaml or bundle_pre_1_25.yaml>
----

.. Delete the Trident orchestrator CRD:
+
----
kubectl delete -f deploy/crds/trident.netapp.io_tridentorchestrators_crd_post1.16.yaml
----

.. Clean up any other artifacts before running Helm install:
+
----
...
+
----
k delete psp tridentoperatorpod
----
...
//----
----
helm install trident netapp-trident/trident-operator --version 100.2402.0 --set acpImage=<acp image> --set enableACP=true --set operatorImage=netapp/trident-operator:24.02.0 --set tridentAutosupportImage=docker.io/netapp/trident-autosupport:24.02 --set tridentImage=netapp/trident:24.02.0 --namespace trident
----
...
//----
----
helm install trident netapp-trident/trident-operator --version 100.2402.0 --set acpImage=<acp image> --set enableACP=true --set imageRegistry=<your-registry>/sig-storage --set operatorImage=netapp/trident-operator:24.02.0 --set tridentAutosupportImage=docker.io/netapp/trident-autosupport:24.02 --set tridentImage=netapp/trident:24.02.0 --namespace trident
----
...
*Do not* run the obliviate command: `./tridentctl oblivate crd -n trident` 
--
====
// end tabbed block
