...
.Steps
. You can add a new storage backend by navigating prompts from the Dashboard or the Backends menu:
* From *Dashboard*:
...
You can bring an existing ONTAP or Astra Data Store storage backend into Astra Control Center management.
