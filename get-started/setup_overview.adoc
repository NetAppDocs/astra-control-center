...
* <<Complete prerequisites for cluster management>>
* <<Add cluster>>
...
You should ensure that the prerequisite conditions are met before you add a cluster. You should also run eligibility checks to ensure that your cluster is ready to be added to Astra Control Center and create roles for cluster management.
...
* Before you add a cluster, review and perform the necessary <<Complete prerequisites for cluster management,prerequisite tasks>>.
