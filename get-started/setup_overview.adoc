...
Without a license, your usage of Astra Control Center is limited to managing users and adding new clusters. You can add a new license using the UI or API to gain full functionality. To update an existing evaluation or full license, see link:../use/update-license.html[Update an existing license].
