...
Astra Control Center supports and monitors ONTAP and Astra Data Store as the backend storage. After you install Astra Control Center, log in to the UI, and change your password, you'll want to set up a license, add clusters, manage storage, and add buckets.
...
... Select the managed compute cluster and click *Next*.
