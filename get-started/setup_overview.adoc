...
You can try Astra Enterprise with an Evaluation license, which lets you use Astra Enterprise for 90 days from the date you downloaded Astra Enterprise. You need to work with your NetApp sales contact to obtain an evaluation license, which is associated with your NetApp Support account.

. Log in to the Astra Enterprise UI.
. From the left navigation, select *Account* > *Licenses*.
. Select the Add License dropdown, and choose *Connect to NetApp Support*.
