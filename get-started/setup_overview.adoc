...
* If you are deploying Astra Data Store, you have uploaded the version of the installation bundle you intend to deploy to a location that is accessible to Astra Control.
...
* From *Dashboard*:
.. From the Storage backend section, select *Manage*.
...
.. Select the *Astra Data Store* option within the *Deploy* tab.
...
+
NOTE: If you have not yet uploaded the version you intend to deploy, you can exit the wizard and use the package service to upload the installation bundle.
