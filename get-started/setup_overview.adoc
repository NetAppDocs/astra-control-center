...
* <<Prepare your environment to add a cluster>>
* <<Add cluster>>
...
* Before you add a cluster, review and perform the necessary <<Prepare your environment to add a cluster,prerequisite tasks>>.
