...
You can add an existing storage backend so that Astra Control can manage its resources.
...
You can bring a discovered ONTAP storage backend into Astra Control Center management.
