...
ssl modify -vserver aff250-astra-01-02 -ca <CA>  -server-enabled true -serial <serial number>       (security ssl modify)
 
==
# Verify if the certificate works fine:
 
openssl s_client -CAfile ca_root.crt -showcerts -servername server -connect aff250-astra-01-02-cm.rtp.openenglab.netapp.com:443
CONNECTED(00000005)
...
security certificate install -type client-ca -vserver aff250-astra-01-02
