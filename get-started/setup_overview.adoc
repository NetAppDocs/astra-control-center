...
You can add a license to Astra Control Center using the API. See the link:https://docs.netapp.com/us-en/astra-automation/index.html[API documentation] for more details.
