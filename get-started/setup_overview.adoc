...
+
NOTE: Astra Data licenses with full permissions are associated with your Kubernetes cluster, and these associated cluster should appear automatically.
For Astra Data Store preview licenses, you must add a cluster to Astra Control management to proceed if you have not done so already. If no association has been made between the preview license and cluster, you can define this association on the next page.
