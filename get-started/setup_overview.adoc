...
[source,Console]
----
openssl req -new -newkey rsa:4096 -nodes -sha256 -subj "/" -outform pem -out aff250-astra-01-02.csr -keyout aff250-astra-01-02.key -addext "subjectAltName = DNS:<Your DNS information>,IP:<Your IP address>,DNS:aff250-astra-01-02"
----
