...
TIP: We recommend that Astra Control Center also manages the cluster it is deployed on first before you add other clusters to Astra Control Center to manage. You can do this using the *Add Cluster* feature. 
