...
NOTE: Astra Control Center can manage clusters and applications that use IPv4 or IPv6 networking. It doesn't matter if your cluster is configured for either or both protocols, Astra Control Center will discover and manage it.
