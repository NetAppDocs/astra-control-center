...
NOTE: If you add a cluster using the command line, keep in mind the following limitations for the cluster:
* You cannot use storage backends connected with the `nas-economy` driver with the cluster.
