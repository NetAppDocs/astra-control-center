...
** Clusters running OpenShift 4.6, 4.7, or 4.8
...
* Astra Trident StorageClasses configured with a link:requirements.html#supported_storage_backends[supported storage backend] (required for any type of cluster)
