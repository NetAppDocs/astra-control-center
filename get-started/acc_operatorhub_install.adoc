...
* *Astra Control Center operator version support*: Install the latest operator (`acc-operator`) if you are upgrading to the 23.07 Astra Control Center. You cannot upgrade to other versions of Astra Control Center using this operator.
...
+
//Must be updated every quarterly release
NOTE: Beginning with Astra Control Center 23.07 release, it's recommended that you install the latest operator (`acc-operator`) if you are upgrading from Astra Control Center 22.08 or later. If you are upgrading from a version earlier than 22.08, use your existing operator to deploy 23.07 and then upgrade your operator to the latest version for all future releases.
