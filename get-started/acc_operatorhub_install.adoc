...
If you use Red Hat OpenShift, you can install the Astra Control Center using its operator. Use this procedure to install Astra Control Center from the https://catalog.redhat.com/software/operators/explore[Red Hat Ecosystem Catalog^] or using the Red Hat OpenShift Container Platform.
...
. Do one of the following to access OperatorHub:
...
.. https://catalog.redhat.com/software/operators/detail/611fd22aaf489b8bb1d0f274[Select^] the NetApp Astra Control Center operator.
.. Select *Install*.
...
.. Select *Install*.
+
NOTE: If you selected a manual approval strategy, you will prompted to approve the manual install plan for this operator.
