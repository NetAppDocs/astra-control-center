...
+
image:openshift_operatorhub.png["Image shows the Astra Control Center install page from the OpenShift Container Platform UI"]
...
+
image:red_hat_catalog.png["Image shows the Astra Control Center overview page that is available from the RedHat Ecosystem Catalog"]
...
image:openshift_acc-operator_details.png["Astra Control Center operator page that has the Astra Control Center tab selected"]
