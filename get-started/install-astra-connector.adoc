...
* When you perform these steps, execute these commands on the cluster that you want to manage with Astra Control Service.
...
+
* *<ASTRA_CONTROL_SERVICE_URL>*: The web UI URL of Astra Control. For example:
+
----
