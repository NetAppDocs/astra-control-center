...
. At the Astra Control Center login page, enter the value you used in the `email` in `astra_control_center_min.yaml` CR when <<Install Astra Control Center using the command-line utility,you installed ACC>>.
+
