...
. Push the Astra Control Center images to this ACR registry. 
+
Optionally, if you need to push images from an Azure registry rather the default public Astra registry, see the following example script:
+
----
...
ASTRA_REGISTRY=<source ACC image Azure repository>
