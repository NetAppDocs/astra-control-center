...
If you are an existing Trident user (this includes any users of Astra Trident in the public cloud), you need to acquire an Astra Control license first. After you do, you can download the Astra Control Provisioner bundle, upgrade Astra Trident, and enable Astra Control Provisioner functionality.
