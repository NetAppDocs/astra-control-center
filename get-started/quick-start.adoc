...
+
Optionally, install Astra Control Center from the Red Hat OperatorHub.

* Discover your Trident configuration backed by the ONTAP storage backend. Or, discover your Astra Data Store clusters as your storage backend.
+
