...
* link:../get-started/prep-for-cluster-management[Configure ONTAP credentials]
...
* link:../get-started/prep-for-cluster-management[Prepare your environment for cluster management]
* link:../get-started/add-cluster.html[Add a cluster]
* link:../get-started/add-storage-backend.html[Add a storage backend]
* link:../get-started/add-bucket[Add a bucket]
