...
NOTE: The time taken for ASUP bundle collection depends on the size of the installation and the ASUP bundle itself. The longer the duration of ASUP bundle collection, longer it might take to collect the bundle.
