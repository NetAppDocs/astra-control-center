...
*** https://docs.aws.amazon.com/ebs/[Amazon Elastic Block Store (EBS)^] or https://docs.aws.amazon.com/fsx/[Amazon FSx for NetApp ONTAP^] as backend storage options for AWS clusters.
+
