...
. If you are planning to push Astra Control Center package images to your local registry, complete the appropriate step sequence for your container engine:
+
[role="tabbed-block"]
====
.Docker
