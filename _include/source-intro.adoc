...
Astra Control Center supports Kubernetes clusters with: Trident storage backends with ONTAP 9.5 and above.
...
* Discovers details about the cluster including namespaces and enables you to define and protect the apps.
