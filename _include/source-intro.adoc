...
Astra Control Center supports Kubernetes clusters with a Astra Control Provisioner-configured storage class with an ONTAP 9.5 and above storage backend.
