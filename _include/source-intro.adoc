...
+
** For GKE clusters, Astra Control Service uses https://www.netapp.com/google-cloud/netapp-volumes/[NetApp Cloud Volumes Service for Google Cloud^] or Google Persistent Disks as the storage backend for your persistent volumes.
+
** For AKS clusters, Astra Control Service uses https://www.netapp.com/azure/azure-netapp-files/[Azure NetApp Files^] or Azure managed disks as the storage backend for your persistent volumes.
+
