...
delivered both as software you install on-premises (Astra Control Center) and as a fully managed service (Astra Control Service). Both deployment models offer the same app-data management capabilities to Kubernetes applications.
