...
NOTE: Applications deployed from Google Marketplace to Astra Control Service have not been validated. Some users report issues with discovery and/or backup with Google Marketplace deployments of Postgres, MariaDB, and MySQL.
