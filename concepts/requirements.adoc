...
Astra Control Center communicates using the following TCP ports. You should ensure that these ports are allowed through any firewalls:
...
|HTTPS
|Ingress
|Metrics Inbound from managed clusters

|*TBD*
|HTTPS
|Ingress
|Logging Inbound from managed clusters

|9090
|HTTPS
|Ingress
|OpenMetrics to Metrics consumer (Prometheus)

|n/a
|HTTPS
|Ingress
|CI/fluentbit/telegraf data to Cloud Insights

|n/a
|HTTPS
|Egress
|Fleuntbit to logs consumer (Elastic Search)
